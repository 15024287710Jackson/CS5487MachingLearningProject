...
training_model_path = "./alexnet8_training_model/traning_mnist_model.ckpt"
...
recoeding = model.fit(training_data, training_label, batch_size=32, epochs=5, validation_data=(val_data, val_label), validation_freq=1,
